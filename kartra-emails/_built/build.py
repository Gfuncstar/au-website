...
__CTA_BLOCK__
          ...
          <tr>
            <td style="background-color:#212121;padding:32px 40px;" class="px">
              ...
              <p style="margin:0 0 12px 0;font-family:'Lato',Helvetica,Arial,sans-serif;font-size:12px;line-height:1.5;color:#FFFFFF;opacity:0.55;">Aesthetics Unlocked, 17a Friars Lane, Braintree, Essex CM7 9BL<br />Replies welcome &mdash; <a href="mailto:hello@aunlock.co.uk" style="color:#FFFFFF;text-decoration:underline;">hello@aunlock.co.uk</a>.</p>
