...
*Anchor:* Vascular (flushing, telangiectasia), neurogenic (nerve-driven sensitivity, burning), innate immune (LL-37, TLR-2 over-expression), and barrier (impaired stratum corneum, water loss, microbial imbalance).

### 3. Describe what happens to the facial vasculature in repeated flushing episodes.

*Anchor:* Repeated dilation without recovery weakens vessel walls, becomes persistent erythema, and over time forms visible telangiectasia. Vessel reactivity also increases, lowering the threshold for the next flare.
...
*Anchor:* Erythematotelangiectatic (persistent central redness + visible vessels), papulopustular (inflammatory papules and pustules without comedones), phymatous (skin thickening, most often nasal), and ocular (gritty, dry, red-margined eyes). A client can sit on more than one pattern at once.

### 9. Which features must always prompt a referral to a GP or dermatologist?

*Anchor:* Suspected ocular involvement, phymatous change, severe or rapidly progressive disease, suspected diagnosis other than rosacea, and any psychological distress that exceeds your scope of in-clinic support.
...
*Anchor:* Calm before correct. Identify and remove triggers, repair the barrier, daily SPF, gentle cleansing, no actives during a flare. The foundation phase often runs 4–8 weeks before any in-clinic treatment is appropriate.

### 12. Which in-clinic treatments are appropriate for stable rosacea, and which are contraindicated?

*Anchor:* Appropriate (when the skin is stable): IPL or vascular laser for telangiectasia, low-energy LED, very gentle enzymatic resurfacing under expert hands. Contraindicated or high-risk: aggressive chemical peels, microneedling on active inflammation, ablative resurfacing, anything heating the skin during a flare.

### 13. Why is daily SPF a non-negotiable part of homecare advice?

*Anchor:* UV is one of the most consistent triggers across all rosacea phenotypes. SPF is the cheapest, most universal intervention you can give a client and the one most likely to reduce flare frequency over months.

### 14. In a reactive / neurogenic case, what is the primary treatment goal?

*Anchor:* De-escalation. Reduce the nervous-system reactivity by stripping the routine back, removing irritants, repairing barrier, and explicitly slowing the pace of any new product introduction. The goal is fewer flares, not faster results.
