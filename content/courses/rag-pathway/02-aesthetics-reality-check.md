...
Aesthetics in England does not operate in a neat, clearly defined system. It exists within a **fragmented but tightening regulatory landscape** that many practitioners misunderstand or underestimate.

This module is designed to replace assumption with clarity and confidence with competence. It is not here to frighten you or limit your ambition. **It exists to protect you, your clients, and your future in this industry.**

True professionalism begins with understanding the environment you operate in. Without that understanding, even well-intentioned practitioners place themselves at risk.
...
This clarity is foundational. Everything else in this programme builds on it.

## How aesthetics is structured in England

Non-surgical aesthetics in England is not a single, regulated profession. It is a **patchwork** of overlapping legal duties, voluntary frameworks, and professional standards that depend almost entirely on **who you are, what you do, and where you do it**.
...
- Botulinum toxin (Botox, Azzalure, Bocouture)
- Dermal fillers prescribed and supplied by a prescriber
- Skin-boosting injectables (e.g. Profhilo, polynucleotides)
- Prescription-strength chemical peels
- Any treatment requiring a Prescription-Only Medicine (POM)
- IV vitamin therapy and prescription-only weight management

These treatments require:

- A face-to-face prescriber consultation (remote prescribing of injectables for cosmetic use is no longer accepted as best practice and is opposed by the GMC, NMC, GPhC and CQC)
- A legal supply chain through a registered pharmacy
- A practitioner working within their professional registration and scope

**Non-medical aesthetic treatments** include:

- Most facials, microneedling (CE-marked devices, non-medical depth), microdermabrasion
- Cosmetic-grade chemical peels
- LED, radiofrequency, and most light-based aesthetic devices in non-medical settings
- Lash, brow, and skin-finishing services

**Key point:** A treatment is "medical" if it requires a POM, breaks the skin to a clinical depth, or carries a clinical risk profile that would normally be managed by a registered healthcare professional. The marketing language used to sell it is irrelevant to its legal classification.
...
|------|-----------------|
| MHRA | Medicines, medical devices, advertising of POMs, device safety reporting |
| GMC / NMC / GPhC / GDC | Professional conduct of doctors, nurses, pharmacists, dentists |
| CQC | Healthcare services that meet the regulated activity threshold |
| Local authorities | Premises licensing under skin-piercing and special-treatment by-laws |
| ASA / CAP | Marketing claims, social media advertising, before-and-afters |
| JCCP | Voluntary register and code of practice for non-surgical practitioners |
| HSE | Workplace and infection-prevention duties |
| ICO | Data protection and consent records |
...
- A statutory licensing scheme for premises and practitioners
- Tiered restrictions based on procedure risk
- Minimum training and qualification thresholds
- Age restrictions on cosmetic injectables (already in force for under-18s since 2021)
- Tighter advertising enforcement by the ASA and MHRA

**Why this matters:** Practitioners who position themselves above the future minimum standard now will move into licensing without disruption. Practitioners who only meet today's bare minimum will face the steepest climb.
...
## Where you sit within the system
