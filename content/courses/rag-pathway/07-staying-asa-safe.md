...
icon: warning
duration: "16 min"
summary: "How to be visible online without crossing the lines that the ASA, CAP, and MHRA are now actively enforcing."
---

Visibility without compliance creates **vulnerability**. This module covers the ASA and CAP code rules as they apply to cosmetic interventions, the claims that are simply not permitted (including naming Prescription-Only Medicines such as Botox), the rules around before-and-after imagery, influencer and gifted-content compliance, how to audit your social media language, and the rules of implication and inference that catch many otherwise careful practitioners out.

The goal is a marketing practice that **grows your reputation rather than quietly putting it at risk every time you post**.

## Learning outcomes

By the end of this module, you will be able to:

- Identify the headline ASA / CAP rules that apply to your marketing
- Audit your social media against the POM-advertising rules
- Run a defensible before-and-after content workflow
- Brief an influencer or gifted-content partner correctly
- Spot the implication-and-inference traps that catch careful practitioners
- Build a marketing voice that is compelling *and* compliant

## 1. Why marketing sits inside the regulatory frame
...
- **Botulinum toxin** (and every brand: Botox, Azzalure, Bocouture, Alluzience, Letybo, Nuceiva) **cannot be named** in marketing aimed at the public
- Polynucleotides supplied as POMs cannot be advertised by name
- Any prescription-only filler cannot be advertised by name
- IV vitamin therapy and prescribed weight-management injectables sit under the same rule
...
- Name the medicine, the brand, or the active ingredient in any public-facing material
- Use price lists, menu pages, social posts, stories, reels, blogs, paid ads, or Google ads to name the medicine
- Use hashtags that name the medicine (#botox, #azzalure)
- Allow influencers, third parties, or gifted-content partners to name the medicine on your behalf
- Use FAQs, pricing pages, or "about" sections to name the medicine
...
- Specific written consent for marketing use, separate from clinical consent
- Clear about platforms (website, social, paid ads, in-clinic display)
- Clear about retention and right to withdraw
- Recorded and version-dated

**Capture**

- Same lighting, same angle, same expression, same distance
- No filters, no smoothing, no skin-finishing apps
- Both images dated and stored on the clinical record
...
- No POM name in caption, alt-text, or hashtags
- No claim that overstates what is shown
- No comparison that disparages another practitioner or brand

**Common mistakes:**

- Using the same image set on three different platforms with three different captions, only one of which is compliant
- Editing skin in the "after" image to amplify the apparent result
...
Every person who creates content about your services on your behalf brings your compliance position with them.

A defensible influencer / gifted-content workflow includes:

- A **written brief** that lists what they cannot say (POM names, exaggerated claims, specific medical claims)
- Confirmation that all posts will be clearly **labelled as advertising** (#ad, paid partnership) per CAP
- A pre-publication review right in the agreement
- Confirmation that you will retain copies of every post made on your behalf
- A clause that misuse will result in unpublishing and contract termination

**Important clarification:** ASA / CAP responsibility for an influencer's post sits jointly with the influencer **and the brand**. You cannot outsource the compliance risk by outsourcing the post.
...
- Did any post, story, reel, or comment-reply name a POM?
- Did any caption make an objective claim you cannot substantiate?
- Were before-and-after images consented, dated, unfiltered, and accurately captioned?
- Were influencer / gifted posts labelled as advertising and within the brief?
- Did any content imply a POM by image, hashtag, or pricing context?
- Was any under-18 imagery used in a cosmetic injectables context?

Mark each one Green, Amber, or Red. The Reds come down today. The Ambers get rewritten this week.

The next module on Training, Qualifications & CPD takes the same evidenced discipline and applies it to your **practitioner record**.
