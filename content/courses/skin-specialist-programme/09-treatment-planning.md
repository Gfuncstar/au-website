...
- Stacking peels, microneedling, and light
- Recovery timelines and downtime planning
- Risk hierarchy (PIH, barrier crash, infection)
- Documentation across multi-modal plans

## 1. Single-modality vs combination thinking

Most stalled plans aren't stalled because the modality was wrong. They're stalled because the modality was working alone when it should have been working in concert.
...
- Multi-mechanism conditions (rosacea, photoageing, scarring, melasma)
- Established condition needing both clearance and prevention
- Clients with realistic timelines and good adherence
- Mixed-pattern presentations (most adult skin)

**Clinical principle:** Combination therapy compounds when sequenced correctly. It crashes when stacked carelessly. The skill is in the sequencing.

## 2. Active sequencing rules

The same principles from Module 6 (barrier), now systematic across the full home-care plan:

**Foundational rules:**

- One new active per 4 weeks, minimum
- Always lead with barrier repair if any compromise present
- SPF every day, no exceptions
- Photosensitising actives (retinoids, AHAs) at night
- Antioxidants (vitamin C) in morning, paired with SPF

**Common evidence-based combinations that work:**

- Vitamin C (morning) + retinoid (night) + barrier support both ends + SPF
- BHA (morning, oily skin) + retinoid (night) + barrier + SPF
- Azelaic acid (twice daily, melasma / rosacea) + barrier + SPF (mineral)
- Niacinamide (morning) + retinoid (night) + barrier + SPF

**Common combinations that crash:**
...
- Morning routine: list each step, in order
- Evening routine: list each step, in order
- Frequency notes (e.g. "retinoid 3x/week building to nightly over 8 weeks")
- Recovery weeks (e.g. "no actives the week after each peel")

The client doesn't have to remember the rules. The plan does.

## 3. Stacking peels, microneedling, and light
...
## 4. Recovery timelines and downtime planning

The recovery conversation is part of the consultation. Clients need to know:

**For each modality:**

- **Day-of:** what they'll feel, what to do at home
- **Days 1-3:** expected appearance and sensations
- **Week 1:** healing milestones
- **Weeks 2-4:** when normal activity resumes
- **6-12 weeks:** when results become visible

**Schedule downtime around:**

- Significant social / professional events (weddings, presentations, work commitments)
- Holiday / sun exposure (most procedures need 2-4 weeks of strict photoprotection after)
...
When something goes wrong, it's almost always one of:
...
## 6. Documentation across multi-modal plans

The clinical record for a multi-modal plan should contain:

- Initial consultation and classification
- Plan with all modalities, sequencing, and timelines
- Consent for each modality (separate, version-dated)
- Photographic baseline + every visit
- In-clinic procedure record (date, parameters, settings, post-procedure observation)
- Home-care plan with morning + evening routines
