...
export const GENERAL_FAQS: readonly FAQGroup[] = [
  ...
  },
  {
    ...
    items: [
      {
        q: "How do I pay?",
        a: "Card payments via Stripe (Visa, Mastercard, Amex). Prices are in GBP. VAT applied where required. One-off payment per course, no subscriptions.",
      },
      {
        q: "How long do I have access for?",
        a: "Lifetime access on every paid course (Acne Decoded, Rosacea Beyond Redness, The Skin Specialist™ Programme, the 5K+ Formula, the RAG Pathway). You'll also receive every future update as guidance evolves, at no extra cost.",
      },
      {
        q: "Are courses transferable or shareable?",
        a: "No. Each enrolment is for a single named practitioner. If you'd like to enrol your team, get in touch and I'll arrange a multi-seat option.",
      },
      {
